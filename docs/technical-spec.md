...
P1-2 将 SakanaAI/AI-Scientist `1de1dbc1f4ee2c5f61e9c94348d55eb51d7fa2eb` 和 NPEET `8b0d9485423f74e5eb199324cf362765596538d3` 固定为 `upstream/` 下的独立 Git submodule。远端 reference root 为 `/data/tangmingxue/experiments/ai-scientist-2d-diffusion`，使用 conda 26.7.1、Python 3.11.16、PyTorch 2.14.0+cu130；完整版本见 `reproductions/ai-scientist-2d-diffusion/2026-09-23-preflight/`。四张 GPU 预检时均被占用，尚未运行训练。
